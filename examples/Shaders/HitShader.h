 ...
 */
class BasicHitShader : public IHitShader
{
  public:
    BasicHitShader() {}
    ...
    [[nodiscard]] std::unique_ptr<IHitShader> Clone() const override { return std::make_unique<BasicHitShader>(*this); }

    ShaderOutput Shade(uint64_t                             id,
