 ...
 */
class PerspectiveGeneratorShader : public IRayGeneratorShader
{
  public:
    std::unique_ptr<IRayGeneratorShader> Clone() const override
    {
        return std::make_unique<PerspectiveGeneratorShader>(*this);
    }
